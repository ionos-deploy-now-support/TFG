...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8Xt44MbcKy', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('16OYFoGIYL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tlvaCRDhLN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uQYxFgXb6C', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['E:\\TFG\\src\\Entity'], true)), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\DotesRepository' => ['privates', 'App\\Repository\\DotesRepository', 'getDotesRepositoryService', true],
        ], [
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'E:\\TFG/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('E:\\TFG/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['E:\\TFG\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'E:\\TFG\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => ''], 'E:\\TFG', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AwU0BH9Tj1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NxdnlFFRnK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('RWiBoBnQ3t', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9wfaCi+Zck', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HbfAHtG2fV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'E:\\TFG', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'E:\\TFG', true);
    }
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.cy.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.cy.xlf'], 'da' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => ['E:\\TFG\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 'E:\\TFG\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 'E:\\TFG\\vendor\\symfony\\security-core/Resources/translations\\security
\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'E:\\TFG\\vendor\\symfony\\debug-bundle/translations', 'E:\\TFG\\vendor\\symfony\\twig-bundle/translations', 'E:\\TFG\\vendor\\symfony\\web-profiler-bundle/translations', 'E:\\TFG\\vendor\\symfony\\stimulus-bundle/translations', 'E:\\TFG\\vendor\\symfony\\ux-turbo/translations', 'E:\\TFG\\vendor\\twig\\extra-bundle/translations', 'E:\\TFG\\vendor\\symfony\\security-bundle/translations', 'E:\\TFG\\vendor\\symfony\\monolog-bundle/translations', 'E:\\TFG\\vendor\\symfony\\maker-bundle\\src/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\TFG');
        $a->addPath('E:\\TFG\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\TFG\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\TFG\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\TFG\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\TFG\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\TFG\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\TFG\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\TFG\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\TFG\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\TFG\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\TFG/templates');
        $a->addPath('E:\\TFG\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\TFG\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\TFG\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'E:\\TFG', 'UTF-8'));
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['E:\\TFG\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\TFG\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\TFG\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\TFG\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\TFG\\vendor\\symfony\\maker-bundle\\src',
            ...
            'translator.default_path' => 'E:\\TFG/translations',
            ...
            'twig.default_path' => 'E:\\TFG/templates',
