...
<div>
    ...
    {% for revision in revisiones %}
        <li>
            ...
            <a href=\"{{ path(\"app_comprobar_clase\", {'id': revision.id}) }}\">Ver más</a>
            <a href=\"{{ path('app_validar_clase', {'id': revision.id}) }}\">Validar clase</a>
            <a href=\"{{ path('app_eliminar_clase', {'id': revision.id}) }}\">Eliminar clase</a>
        </li>
    {% endfor %}
    </ul>
</div>

{% endblock %}", "revisiones/revisiones_clase.html.twig", "C:\\Users\\alopa\\OneDrive\\Escritorio\\xampp2\\htdocs\\Symfony\\TFG\\templates\\revisiones\\revisiones_clase.html.twig");
    }
}
