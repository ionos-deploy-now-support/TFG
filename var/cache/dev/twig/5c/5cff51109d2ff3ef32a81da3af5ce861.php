...
class __TwigTemplate_9041b28f39a4f1d0761036826b29003e extends Template
{
    private $source;
    private $macros = [];
 ...
 <a href=\"";
        // line 11
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_solicitud_subraza");
        echo "\">
        <span>Ir a las solicitudes de Subrazas</span>
</a>
...
<style>
 ...
 {{ form(form) }} 
 <a href=\"{{ path(\"app_solicitud_subraza\") }}\">
        <span>Ir a las solicitudes de Subrazas</span>
</a>


{% endblock %}
", "solicitudes/razas.html.twig", "/opt/TFG/templates/solicitudes/razas.html.twig");
    }
}
