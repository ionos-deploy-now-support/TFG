...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BuscadorController' => 'getBuscadorControllerService',
            'App\\Controller\\IndexController' => 'getIndexControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\PersonajeController' => 'getPersonajeControllerService',
            ...
            'App\\Controller\\SolicitudesController' => 'getSolicitudesControllerService',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FlpYMWY4gZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['E:\\TFG\\src\\Entity'], true), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\HabilidadesRepository' => ['privates', 'App\\Repository\\HabilidadesRepository', 'getHabilidadesRepositoryService', true],
            'App\\Repository\\HechizosRepository' => ['privates', 'App\\Repository\\HechizosRepository', 'getHechizosRepositoryService', true],
            'App\\Repository\\ListaHechizosRepository' => ['privates', 'App\\Repository\\ListaHechizosRepository', 'getListaHechizosRepositoryService', true],
            'App\\Repository\\PactosRepository' => ['privates', 'App\\Repository\\PactosRepository', 'getPactosRepositoryService', true],
            'App\\Repository\\RazasRepository' => ['privates', 'App\\Repository\\RazasRepository', 'getRazasRepositoryService', true],
            'App\\Repository\\SolicitudesRepository' => ['privates', 'App\\Repository\\SolicitudesRepository', 'getSolicitudesRepositoryService', true],
            'App\\Repository\\SubclasesRepository' => ['privates', 'App\\Repository\\SubclasesRepository', 'getSubclasesRepositoryService', true],
            'App\\Repository\\SubrazasRepository' => ['privates', 'App\\Repository\\SubrazasRepository', 'getSubrazasRepositoryService', true],
            'App\\Repository\\TrasfondoRepository' => ['privates', 'App\\Repository\\TrasfondoRepository', 'getTrasfondoRepositoryService', true],
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\BuscadorController', 'App\\Controller\\IndexController', 'App\\Controller\\LoginController', 'App\\Controller\\PersonajeController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SeguridadController', 'App\\Controller\\SolicitudesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('HLNmrZ964G', 0, $container->getParameter('container.build_id'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V0z++BC0HM', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dnSsY7yqiF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k33VLMRV0w', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('BCa2EPoSOM', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ylj0U+pR8U', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container)), 'E:\\TFG', false);
    }
