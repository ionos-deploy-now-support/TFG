...
<html>
    ...
    <body>
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 23, $this->source); })()), "user", [], "any", false, false, false, 23)) {
            ...
            echo "\" class=\"menu_logout\"><li><i class=\"icofont-logout\"></i></li></a>
            ";
        } else {
            // line 27
            echo "                <a href=\"";
            ...
            echo "\" class=\"menu_login\"><li><i class=\"icofont-login\"></i></li></a>
            ";
        }
        // line 30
        echo "           
...
";
    ...
    {
        return array (  220 => 34,  201 => 13,  191 => 14,  188 => 13,  178 => 12,  164 => 8,  154 => 7,  135 => 5,  112 => 35,  110 => 34,  104 => 30,  99 => 28,  94 => 27,  89 => 25,  84 => 24,  82 => 23,  76 => 20,  72 => 19,  66 => 15,  64 => 12,  61 => 11,  59 => 7,  54 => 5,  48 => 1,);
    }
    ...
    <body>
        ...
        <ul class=\"menu\">
            ...
            {% if app.user %}
                ...
                <a href=\"{{ path(\"app_logout\") }}\" class=\"menu_logout\"><li><i class=\"icofont-logout\"></i></li></a>
            {% else %}
                <a href=\"{{ path(\"app_solicitudes\") }}\"><li>Solicitudes</li></a>
                <a href=\"{{path(\"app_login\")}}\" class=\"menu_login\"><li><i class=\"icofont-login\"></i></li></a>
            {% endif %}
