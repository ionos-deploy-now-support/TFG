...
class __TwigTemplate_329c712b0b79875130ba0d4c0f45a082 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"formulario2 \">
 ...
 ";
    ...
    <div class=\"row\">
        <div class=\"C\">
            ";
        // line 47
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "AtaqueDesarmado", [], "any", false, false, false, 47), 'row');
        yield "
        </div>
        <span class=\"E\"></span>
        <div class=\"A\"><br>
            ";
        // line 51
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "raza_id", [], "any", false, false, false, 51), 'row');
        yield "
        </div>
    </div>
     <div class=\"row\">
 ...
 ";
    ...
    {
        return array (  151 => 63,  145 => 60,  138 => 56,  130 => 51,  123 => 47,  115 => 42,  108 => 38,  100 => 33,  93 => 29,  85 => 24,  78 => 20,  70 => 15,  63 => 11,  57 => 8,  51 => 4,  47 => 3,  36 => 1,);
    }
