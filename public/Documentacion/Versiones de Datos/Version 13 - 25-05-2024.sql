...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2024 a las 13:58:53
...
(2, 'Sentidos agudizados', 'Siempre estás alerta, buscando potenciales peligros en cualquier parte. ', 'Ninguno.', '+5 a las tiradas de iniciativa.\r\nNo puedes ser sorprendido mientras estés consciente.\r\nLas otras criaturas no ganan ventaja en las tiradas de ataque contra ti como resultado de estar fuera de tu rango', 1, 'Wizards of the Coast', 'https://www.freeiconspng.com/thumbs/alert-icon/alert-icon-red-11.png');
...
(123, 'fffsf', 'fsfsf', 'Anónimo', 0, 'subclases_7', 1),
(124, 'dbd', 'dvdfvbd', 'Anónimo', 0, 'subclases_7', 7),
(125, 'fss', 'fsfs', 'Anónimo', 0, 'subclases_7', 10),
(126, 'dvdb bdb', 'srs', 'Anónimo', 0, 'subclases_7', 12),
(127, 'dvddvd', 'ffdv', 'Anónimo', 0, 'subclases_7', 16),
...
(1, 'Humano', 'Raza creada por Athenii, Dios Rúnico de la Batalla.\r\nSon la especie predominante del continente, hábiles maestros de la batalla, saben adaptarse a cualquier conflicto y normalmente los usan a su propio beneficio.', '1', '1', '1', '0', 'Clash of Fates', 30, 'Golpe: 1d4 (Contundente, Fuerza)', 1, '0', '0', 'https://i.pinimg.com/736x/d0/a9/0b/d0a90b7b30fe35ededcc8e195af329c7.jpg'),
...
(7, 1, 'a', 'Ninguno', 'Anónimo', 0, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png');
...
(1, 'República', 'Como ciudadano habituado a República has desarrollado una mente más abierta y no te\r\ncontentas con cualquier información sin contrastar.', 'Origen', 'Común y uno a tu elección entre: Orsfon, Élfico y Hanafu.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
(2, 'Hanafu', 'Como ciudadano habituado a Hanafu te tomas las normas y el honor muy en serio.', 'Origen', 'Común, Hanafu y uno a tu elección entre: Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
(3, 'Orsfon', 'Como ciudadano habituado a Orsfon crees que todo debe seguir las órdenes de alguien, así que crees que hay dos tipos de personas, las que mandan y las que obedecen.', 'Origen', 'Común, Orsfon y uno a tu elección entre: Hanafu, Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
(4, 'Sylfaria', 'Como ciudadano habituado a Sylfaria tienes una profunda conexión con la magia y la naturaleza.', 'Origen', 'Común, Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
(5, 'Pheros', 'Como ciudadano habituado a Pheros valoras tus costumbres y culto a las diferentes deidades protectoras.', 'Origen', 'Común, Pheros.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
(6, 'Ormius', 'Como ciudadano de Ormius eres muy tradicional y artesano.', 'Origen', 'Común, Ormius, y uno a tu elección entre: Trasgo y Draconido.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', ''),
...
(9, 'Soldado', 'Luchaste en batallas', 'Ocupacion', NULL, '5 monedas de oro, 1 arma simple a tu elección y 10 raciones.', 'Supervivencia.', 1, 'Clash of Fates', NULL, ''),
...
(11, 'Viajero', 'Te dedicas a viajar mucho', 'Ocupacion', NULL, '2 monedas de oro, un mapa del Continente o Carta Náutica, 20 raciones y un caballo.', 'Supervivencia y Naturaleza.', 1, 'Clash of Fates', NULL, ''),
(12, 'Pintor', 'Te dedicas a la pintura', 'Ocupacion', NULL, '5 monedas de oro, 10 Lienzos, Herramientas de Pintor, 6 raciones.', 'Elige 3 entre: Naturaleza, Religión, Interpretación, Persuasión, Juego de Manos.', 1, 'Clash of Fates', NULL, ''),
(13, 'Cocinero', 'Te dedicas a la elaboración de platos en cocinas', 'Ocupacion', NULL, '5 monedas de oro, 20 Raciones, Herramientas de Cocinero, Recetario.', 'Elige 2 entre: Naturaleza, Historia, Investigación, Medicina, y Juego de Manos.', 1, 'Clash of Fates', NULL, ''),
(14, 'Herborista', 'Trabajas con hierbas medicinales', 'Ocupacion', NULL, '6 monedas de oro, 10 Raciones, Herramientas de Herborista, Recetario.', 'Elige 2 entre: Naturaleza, Historia, Investigación, Medicina, y Juego de Manos.', 1, 'Clash of Fates', NULL, '');
