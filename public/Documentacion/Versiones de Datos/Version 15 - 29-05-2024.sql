...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2024 a las 17:48:48
...
CREATE TABLE `clases` (
  ...
  `requisitos` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `competencias` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `salvaciones` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `habilidades_aelegir` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `puntos_de_golpe` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `equipamiento` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor` varchar(350) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(41, 'Hola', 'aslfslfj', 'gjrlk', 'Sabiduria', 'sfsfs', '1d4', 'slfjslfj', 'Anónimo', 0, 'https://wallpaperaccess.com/full/1902223.png', 1, '::1', '2024-05-18 15:56:35'),
(42, 'Mercenario', 'aaa', 'aaa', 'aaa', 'aaa', '1d4', 'aaa', 'Pepito', 0, 'https://wallpaperaccess.com/full/1902223.png', 1, '::1', '2024-05-23 16:09:43');
...
CREATE TABLE `dotes` (
  ...
  `descripcion` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `requisitos` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `beneficios` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validado` tinyint(1) NOT NULL,
  `autor` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `dotes` (`id`, `nombre`, `descripcion`, `requisitos`, `beneficios`, `validado`, `autor`, `img`) VALUES
(1, 'Dotes de Actor', 'Aprendiste a imitar voces y sonidos con extrema precisión.', 'Ninguno', '+1 a tu puntuación de Carisma y ventaja en las tiradas de Engaño e Interpretación.', 1, 'Wizards of the Coast', 'https://static.thenounproject.com/png/3582282-200.png'),
(2, 'Sentidos agudizados', 'Siempre estás alerta, buscando potenciales peligros en cualquier parte. ', 'Ninguno.', '+5 a las tiradas de iniciativa.\r\nNo puedes ser sorprendido mientras estés consciente.\r\nLas otras criaturas no ganan ventaja en las tiradas de ataque contra ti como resultado de estar fuera de tu rango', 1, 'Wizards of the Coast', 'https://img.freepik.com/premium-vector/warning-icon-vector-isolated-white-background_162100-446.jpg');
...
CREATE TABLE `habilidades` (
  ...
  `validado` tinyint(1) NOT NULL,
  `origen_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(37, 'Multiataque', 'A partir de nivel 5, cuando uses tu acción para atacar puedes dar 2 golpes.\r\n{11}: Podrás dar 3 golpes.\r\n{20}: Podrás dar 4 golpes.', 'Clash of Fates.', 1, 'clases_1', 5),
(38, 'Indómito', 'Cuando falles una tirada de Salvación, 1 vez por descanso corto, podrás repetir la tirada. Deberás quedarte con el nuevo resultado.\r\n{13}: Puedes usarlo 2 veces por descanso corto.\r\n{17}: Puedes usarlo 3 veces por descanso corto.', 'Clash of Fates', 1, 'clases_1', 9),
...
(113, 'Fulgor Protector', 'Puedes interponer una luz divina entre tú y un enemigo que te ataque. Cuando una criatura a 30 pies o menos de ti y que puedas ver te ataque, podrás usar tu reacción para dar desventaja a su tirada de ataque: haces que una luz resplandezca súbitamente ante ella. Un atacante que no pueda ser cegado es inmune a este rasgo.\r\nPuedes emplear este rasgo tantas veces como tu modificador por Sabiduría (mínimo una vez). Recuperas todos los usos tras finalizar un descanso largo.\r\n{6}: También podrás emplear tu rasgo Fulgor Protector cuando una criatura a 30 pies o menos de ti y que puedas ver ataque a una criatura que no seas tú.', 'Clash of Fates', 1, 'subclases_7', 1),
(114, 'Magia Purificadora', 'Cuando lances un hechizo que cause daño puedes hacer que el daño del hechizo cambie a Radiante si gastas un hueco de hechizo adicional.\r\nSiempre que una criatura muera debido a un hechizo tuyo purificas su alma automáticamente, sin necesidad de\r\nrealizar ningún ritual.\r\nLos No-Muertos y Demonios no pueden resistir tus hechizos y efectos mágicos, además, no pueden recibir efectos positivos tuyos tales como curaciones o beneficios mágicos.', 'Clash of Fates', 1, 'subclases_7', 2),
(115, 'Bendición de Ethios', 'Como acción, tantas veces por descanso corto como tu Nivel de Pacto, puedes bendecirte a ti o a un aliado.\r\nEsa criatura obtendrá +1d4 a sus tiradas de salvación y +1 a sus tiradas de lanzamiento de hechizos y ataque durante 1\r\nminuto. No puedes bendecir a alguien bendecido.\r\n{12}: Obtendrá 1d8 a sus tiradas de salvación y +2 a sus tiradas de lanzamiento de hechizos y ataque durante 1 minuto.', 'Clash of Fates', 1, 'subclases_7', 6),
(116, 'Poder Radiante', 'Al realizar un ataque con un arma cuerpo a cuerpo puedes elegir que ese ataque sea un ataque a distancia, tenga una distancia de 20ft y cause daño Radiante, además se considera un truco.', 'Clash of Fates', 1, 'subclases_7', 8),
(127, 'Luz Divina Cegadora', 'Cuando causes daño Radiante generas un área de 15ft que causa el mismo daño.\r\nTodas las criaturas dentro del área deben hacer una Salvación de Sabiduría (CD de Conjuros), si salvan recibirán la mitad de daño.', 'Clash of Fates', 1, 'subclases_7', 17),
(133, 'fffsf', 'fsfsf', 'Anónimo', 0, 'clases_41', 1),
(134, 'sfsefs', 'dvdfvbd', 'Anónimo', 0, 'clases_41', 4),
(135, 'fss', 'fsfs', 'Anónimo', 0, 'clases_41', 6),
(136, 'sfsfsf', 'fddvd', 'Anónimo', 0, 'clases_41', 10),
(137, 'dvddvd', 'ffdv', 'Anónimo', 0, 'clases_41', 14),
(138, 'Disparar', 'aaaa', 'Pepito', 0, 'clases_42', 1),
(139, 'Correr', 'aaaa{6}: asdadasd', 'Pepito', 0, 'clases_42', 4),
(140, 'aaa', 'sdfasdfg', 'Pepito', 0, 'clases_42', 7),
(141, 'bbb', 'asdfasgasdfg', 'Pepito', 0, 'clases_42', 10),
(142, 'ccc', 'adsfgasdfg', 'Pepito', 0, 'clases_42', 17),
(143, 'Fijar Objetivo', 'Cuando aciertes una tirada de ataque con arma a un objetivo puedes fijarla como objetivo prioritario.\r\nTodas las tiradas de ataque que hagas tú o tus aliados causan daño adicional a esa criatura.\r\nSolo puedes tener fijado un objetivo a la vez.\r\nEl daño contra ese objetivo aumenta 1d6.\r\n{9}: El daño aumenta 1d8.\r\n{15}: El daño aumenta 1d10.', 'Clash of Fates', 1, 'subclases_8', 3),
(144, 'Puntos Débiles', 'Cuando realices una tirada de ataque puedes elegir apuntar a sitios concretos para causar diferentes efectos:{|S|}\r\n{|B|}Pierna: {|/B|}-1 a la tirada de ataque; la velocidad del objetivo se reduce 10ft hasta el final de tu siguiente turno.\r\n{|B|}Brazo: {|/B|}-2 a la tirada de ataque; el objetivo tiene desventaja en las tiradas de ataque que involucren el brazo seleccionado hasta el final de tu siguiente turno.\r\n{|B|}Cabeza: {|/B|}-3 a la tirada de ataque; el daño del ataque aumenta 1d8.\r\n{|B|}Ojo :{|/B|}(Solo Enemigos Predilectos) -10 a la tirada de ataque; el objetivo pierde el ojo durante el resto del día, su visión se reduce a la mitad.\r\nAdicionalmente, todo ataque que aciertes habiendo apuntado causará sangrado en el objetivo (una criatura que sangre pierde vida al principio de cada uno de sus turnos, para evitar dicho sangrado debe superar una tirada de Medicina CD 12 o superior).\r\nEl daño causado por el sangrado es 1d4.\r\n{9}: El daño del sangrado es 1d6.\r\n{13}: El daño del sangrado es 1d8.', 'Clash of Fates', 1, 'subclases_8', 3),
(145, 'Hendir la Herida', 'Una vez por turno, como parte de tu ataque, puedes hacer que una tirada de ataque con arma a distancia tenga ventaja contra un objetivo que esté sangrando, si aciertas, ese objetivo no podrá deshacer su sangrado hasta pasados 2 minutos de haber recibido el ataque.\r\nAdicionalmente, si la criatura está sangrando, puedes elegir apuntar a una de sus heridas con un -4 a la tirada de ataque, si aciertas, la criatura recibirá dos dados de sangrado en el momento y será derribada.', 'Clash of Fates', 1, 'subclases_8', 7),
(146, 'Trofeos de Caza', 'Obtienes competencia con Persuasión.\r\nCuando derrotes a un enemigo puede saquear un Trofeo de Caza, dicho objeto otorgará un modificador igual a la CR de la criatura (mínimo 1, máximo 10) a las tiradas de Carisma (Intimidación, Persuasión) que realices para impresionar, presumir o intimidar en relación a tus habilidades como cazador.', 'Clash of Fates', 1, 'subclases_8', 7),
(147, 'Precisión del Cazador', 'Las tiradas de ataque que hagas contra criaturas que tengas fijadas con Fijar Objetivo doblan tu modificador de competencia.', 'Clash of Fates', 1, 'subclases_8', 11),
(148, 'Recuerdos de la Caza', 'Puedes equiparte un Trofeo de Caza como un talismán de buena suerte en cacerías contra el mismo enemigo que el trofeo, al hacerlo, obtienes resistencia a todos los efectos no mágicos que causase el enemigo.\r\nAdemás, puedes vender los Trofeos de Caza por monedas de plata en cualquier ciudad en el gremio de cazadores, allí te pagarán Xd4 monedas de plata, donde X es la CR del enemigo (mínimo 1).', 'Clash of Fates', 1, 'subclases_8', 11),
(149, 'Maestro de la Caza', 'Los ataques de oportunidad que realices provocan sangrado si aciertan.\r\nEl rango de tus ataques de oportunidad aumenta a la mitad del rango del arma (mínimo 5ft).\r\nPuedes usar tu reacción para dar órdenes a un aliado cuando vaya a hacer un ataque con arma, tu aliado puede elegir hacerte caso, de hacerlo, podrás hacer que aplique una de las opciones de Puntos Débiles, incluyendo el penalizador de la tirada de ataque.', 'Clash of Fates', 1, 'subclases_8', 15),
(150, 'Manos Rápidas', 'Puedes usar tu acción astuta para realizar una tirada de Juego de Manos, esta tirada puede ser empleada con el objetivo de desarmar una trampa, abrir una cerradura, usar un objeto equipado o cambiar de arma.{|S|}Tienes ventaja en la tirada si llevas equipadas tus herramientas de Ladrón', 'Javier Crespo', 1, 'subclases_9', 3),
(151, 'Escapada Imprevisible', 'Tu velocidad de escalado es igual a tu velocidad de movimiento, adicionalmente, si realizas un salto de longitud, puedes sumar tu puntación de destreza a la distancia recorrida.{|S|}Siempre que te hayas movido más de la mitad de tu movimiento, los enemigos tienen desventaja en las tiradas de ataque contra ti', 'Javier Crespo', 1, 'subclases_9', 3),
(152, 'Crear Distracciones', 'Descripcion', 'Javier Crespo', 1, 'subclases_9', 9),
(153, 'Uso de Artefactos', 'd', 'Javier Crespo', 1, 'subclases_9', 13),
(154, 'Reflejos de Ladrón', 'd', 'Javier Crespo', 1, 'subclases_9', 17);
...
CREATE TABLE `habilidades5` (
  ...
  `origen_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `origen_nivel` int(11) NOT NULL,
  `nombre2` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion2` varchar(2500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor2` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado2` tinyint(1) NOT NULL,
  `origen_id2` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `origen_nivel2` int(11) NOT NULL,
  `nombre3` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion3` varchar(2500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor3` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado3` tinyint(1) NOT NULL,
  `origen_id3` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `origen_nivel3` int(11) NOT NULL,
  `nombre4` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion4` varchar(2500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor4` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado4` tinyint(1) NOT NULL,
  `origen_id4` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `origen_nivel4` int(11) NOT NULL,
  `nombre5` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion5` varchar(2500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor5` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado5` tinyint(1) NOT NULL,
  `origen_id5` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `hechizos` (
  ...
  `componentes` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado` tinyint(1) NOT NULL,
  `autor` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `zona_efecto` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tiempo_de_ejecucion` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `pactos` (
  ...
  `descripción` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `razas` (
  ...
  `nombre` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descripcion` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fuerza` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destreza` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inteligencia` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carisma` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `autor` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `velocidad` int(11) NOT NULL,
  `ataque_desarmado` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado` tinyint(1) NOT NULL,
  `constitucion` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sabiduria` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `razas` (`id`, `nombre`, `descripcion`, `fuerza`, `destreza`, `inteligencia`, `carisma`, `autor`, `velocidad`, `ataque_desarmado`, `validado`, `constitucion`, `sabiduria`, `img`) VALUES
(1, 'Humano', 'Raza creada por Athenii, Dios Rúnico de la Batalla.\r\nSon la especie predominante del continente, hábiles maestros de la batalla, saben adaptarse a cualquier conflicto y normalmente los usan a su propio beneficio.', '1', '1', '1', '0', 'Clash of Fates', 30, 'Golpe: 1d4 (Contundente, Fuerza)', 1, '0', '0', 'https://s3-eu-west-2.amazonaws.com/dungeon20/images/561/medium-1c353fa114b17e29befb179c74cd030da806ee0c.jpg?1536946156'),
(2, 'Elfo', 'Raza creada por Igariel, Diosa Rúnica de la Vida, son místicos y conectan con toda la vida que les rodea, no suelen involucrarse en combates a menos que sea necesario.\r\nComo raza portan magia, débil pero suficiente para poder conjurar ciertos hechizos.', '-1', '0', '1', '0', 'Clash of Fates', 30, 'Golpe: 1d4 (Contundente, Fuerza)', 1, '0', '1', 'https://i.pinimg.com/736x/d0/a9/0b/d0a90b7b30fe35ededcc8e195af329c7.jpg');
...
CREATE TABLE `subclases` (
  ...
  `nombre` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `requisitos` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `autor` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `validado` tinyint(1) NOT NULL,
  `img` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `subclases` (`id`, `clase_id`, `nombre`, `requisitos`, `autor`, `validado`, `img`) VALUES
(1, 1, 'Estratega', 'Puntuación de Inteligencia de 12 o superior.', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(2, 1, 'Bélico', 'Puntuación de Fuerza 12 o superior', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(3, 1, 'Domador del Viento', 'Pacto con Cephiros', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(4, 2, 'Escuela del Pergamino', 'Ninguno', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(5, 2, 'Escuela del Gran Tomo', 'Ninguno', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(6, 3, 'Corriente de la Vida', 'Ninguno', 'Clash of Fates', 1, 'https://www.pngfind.com/pngs/m/678-6781082_rowlet-meme-hd-png-download.png'),
(7, 4, 'Cultista de Ethios', 'Pacto con Ethios', 'Clash of Fates', 1, 'https://s3-eu-west-2.amazonaws.com/dungeon20/images/555/medium-7fb8a5247ae92826b0ddd8977c1588da2295cea7.jpg?1536945807'),
(8, 5, 'Cazador', 'Puntuación de Destreza de 14 o superior.', 'Clash of Fates', 1, 'https://s3-eu-west-2.amazonaws.com/dungeon20/images/559/medium-28a7a10320e76a811bd9eadca61ce9e6ab91c495.jpg?1536945924'),
(9, 6, 'Ladrón', 'Puntuación de Destreza de 14 o superior.', 'Javier Crespo', 1, 'https://s3-eu-west-2.amazonaws.com/dungeon20/images/571/medium-ee87ad62b458dcf28b3fcf13d8d8304def14ef4b.jpg?1536946787');
...
INSERT INTO `subrazas` (`id`, `nombre`, `descripcion`, `fuerza`, `destreza`, `inteligencia`, `carisma`, `autor`, `ataque_desarmado`, `validado`, `raza_id`, `constitucion`, `sabiduria`, `img`) VALUES
(1, 'Oriental', 'Humanos de rasgos orientales, piel blanca, pelo de tonalidades negras y ojos generalmente rasgados.\r\nViven en lo que se conoce como Imperio de Hanafu y sus proximidades, no son muy abiertos por lo que no aceptan a según que razas.\r\nCreen en el honor como estilo de vida y lo llevan al límite en sus costumbres.', '1', '0', '0', '0', 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)', 1, 1, '0', '0', 'https://s.keepmeme.com/files/en_posts/20200821/753e3e040857701c5326bf12e7829363pikachu-s-surprised-face-hd-version.jpg'),
(2, 'Desértico', 'Humanos que habitan principalmente el Imperio de Pheros, de piel oscura y constitución fuerte.\r\nEstán acostumbrados a las extremas temperaturas del desierto y a caminar por sus dunas, hacen lo que sea por su supervivencia.', '0', '0', '-1', '0', 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)\r\n', 1, 1, '0', '0', 'https://s.keepmeme.com/files/en_posts/20200821/753e3e040857701c5326bf12e7829363pikachu-s-surprised-face-hd-version.jpg'),
...
(4, 'Elfo de la Luz', 'Elfos afines a la luz, son capaces de iluminar con su poder mágico innato.\r\nPor lo general suelen ser extrovertidos y lanzados. \r\nSu pelo suele ser blanco o rubio, su piel blanca y sus ojos amarillos.', '0', '0', '0', '0', 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)', 1, 2, '0', '0', 'https://s.keepmeme.com/files/en_posts/20200821/753e3e040857701c5326bf12e7829363pikachu-s-surprised-face-hd-version.jpg');
...
CREATE TABLE `trasfondo` (
  ...
  `idiomas` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `objetos_iniciales` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `competencias` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validado` tinyint(1) NOT NULL,
  `autor` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plano` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img` varchar(999) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `trasfondo` (`id`, `nombre`, `descripcion`, `origen`, `idiomas`, `objetos_iniciales`, `competencias`, `validado`, `autor`, `plano`, `img`) VALUES
(1, 'República', 'Como ciudadano habituado a República has desarrollado una mente más abierta y no te\r\ncontentas con cualquier información sin contrastar.', 'Origen', 'Común y uno a tu elección entre: Orsfon, Élfico y Hanafu.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(2, 'Hanafu', 'Como ciudadano habituado a Hanafu te tomas las normas y el honor muy en serio.', 'Origen', 'Común, Hanafu y uno a tu elección entre: Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(3, 'Orsfon', 'Como ciudadano habituado a Orsfon crees que todo debe seguir las órdenes de alguien, así que crees que hay dos tipos de personas, las que mandan y las que obedecen.', 'Origen', 'Común, Orsfon y uno a tu elección entre: Hanafu, Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(4, 'Sylfaria', 'Como ciudadano habituado a Sylfaria tienes una profunda conexión con la magia y la naturaleza.', 'Origen', 'Común, Elfico y Nooru.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(5, 'Pheros', 'Como ciudadano habituado a Pheros valoras tus costumbres y culto a las diferentes deidades protectoras.', 'Origen', 'Común, Pheros.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(6, 'Ormius', 'Como ciudadano de Ormius eres muy tradicional y artesano.', 'Origen', 'Común, Ormius, y uno a tu elección entre: Trasgo y Draconido.', NULL, NULL, 1, 'Clash of Fates', 'Synfol', 'https://visualpharm.com/assets/147/Global%20Citizen-595b40b65ba036ed117d098c.svg'),
(7, 'Mercader', 'Te dedicaste a comerciar objetos', 'Ocupacion', NULL, '8 monedas de oro, 1d4 gemas de valor de 5 de oro, un arma o escudo a tu elección, una balanza y 20 raciones.', 'Perspicacia y Persuasión.', 1, 'Clash of Fates', NULL, 'https://cdnb.artstation.com/p/assets/images/images/030/757/113/large/david-teglassy-render-full-1-camera1-lowres.jpg'),
(8, 'Sastre', 'Trabajas con las pieles', 'Ocupacion', NULL, '3 monedas de oro, 2d4 Pieles de Monstruo, herramientas de sastre, una daga y 10 raciones.\r\n', 'Juego de Manos.', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.flaticon.com/512/1995/1995570.png'),
(9, 'Soldado', 'Luchaste en batallas', 'Ocupacion', NULL, '5 monedas de oro, 1 arma simple a tu elección y 10 raciones.', 'Supervivencia.', 1, 'Clash of Fates', NULL, 'https://cdn4.iconfinder.com/data/icons/medieval-23/340/soldier_knight_medieval_warrior_history_weapon-512.png'),
(10, 'Artesano', 'Eres un especialista en hacer de todo', 'Ocupacion', NULL, '6 monedas de oro, 3 kits de herramientas a tu elección y 10 raciones.\r\n', 'Juego de Manos', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.freepik.com/512/5541/5541150.png'),
(11, 'Viajero', 'Te dedicas a viajar mucho', 'Ocupacion', NULL, '2 monedas de oro, un mapa del Continente o Carta Náutica, 20 raciones y un caballo.', 'Supervivencia y Naturaleza.', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.flaticon.com/512/3124/3124230.png'),
(12, 'Pintor', 'Te dedicas a la pintura', 'Ocupacion', NULL, '5 monedas de oro, 10 Lienzos, Herramientas de Pintor, 6 raciones.', 'Elige 3 entre: Naturaleza, Religión, Interpretación, Persuasión, Juego de Manos.', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.flaticon.com/512/2862/2862538.png'),
(13, 'Cocinero', 'Te dedicas a la elaboración de platos en cocinas', 'Ocupacion', NULL, '5 monedas de oro, 20 Raciones, Herramientas de Cocinero, Recetario.', 'Elige 2 entre: Naturaleza, Historia, Investigación, Medicina, y Juego de Manos.', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.flaticon.com/256/1830/1830839.png'),
(14, 'Herborista', 'Trabajas con hierbas medicinales', 'Ocupacion', NULL, '6 monedas de oro, 10 Raciones, Herramientas de Herborista, Recetario.', 'Elige 2 entre: Naturaleza, Historia, Investigación, Medicina, y Juego de Manos.', 1, 'Clash of Fates', NULL, 'https://cdn-icons-png.flaticon.com/512/1021/1021544.png');
