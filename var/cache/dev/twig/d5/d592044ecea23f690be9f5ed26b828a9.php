...
class __TwigTemplate_c9bc5ef2ebc057fb2f5aee2101c8fdf3 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"indices\">
    ...
    <a href=\"";
        // line 12
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok");
        echo "\">
    ...
    <a href=\"";
        // line 16
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_subclases");
        echo "\">
    ...
    <a href=\"";
        // line 20
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_razas");
        echo "\">
     ...
     <a href=\"";
        // line 24
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_subrazas");
        echo "\">
    ...
    <a href=\"";
        // line 28
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_trasfondos");
        echo "\">
     ...
     <a href=\"";
        // line 32
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_dotes");
        echo "\">
     ...
     <a href=\"";
        // line 36
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_ok_hechizos");
        echo "\">
...
<div class=\"indices\">
    ...
    <a href=\"{{ path(\"app_ok_subclases\") }}\">
        <span><i class=\"icofont-duotone icofont-shield\"></i> Subclases</span> 
    </a>
    
    <a href=\"{{ path(\"app_ok_razas\") }}\">
        <span><i class=\"icofont-users-alt-3\"></i> Razas</span> 
    </a>
    
     <a href=\"{{ path(\"app_ok_subrazas\") }}\">
        <span><i class=\"icofont-user\"></i> Subrazas</span> 
    </a>
    
    <a href=\"{{ path(\"app_ok_trasfondos\") }}\">
        <span><i class=\"icofont-paper\"></i> Trasfondos</span> 
    </a>
    
     <a href=\"{{ path(\"app_ok_dotes\") }}\">
        <span><i class=\"icofont-listine-dots\"></i> Dotes</span> 
    </a>
    
     <a href=\"{{ path(\"app_ok_hechizos\") }}\">
        <span><i class=\"icofont-duotone icofont-wand\"></i> Hechizos</span> 
    </a>
    
</div>
{% endblock %}
", "index/index.html.twig", "/opt/TFG/templates/index/index.html.twig");
    }
}
