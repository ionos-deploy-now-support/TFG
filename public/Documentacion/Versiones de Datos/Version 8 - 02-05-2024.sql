...
(1, 'Sentimiento Dudoso', 'Generas dudas sobre una criatura objetivo que puedas ver a\r\n30ft o menos de ti, esa criatura se replantea su próxima\r\nacción, pues ahora no está segura de si debe o no realizarla.\r\nEsa criatura deberá realizar una tirada de Salvación de\r\nSabiduría (CD Conjuros), si falla, no sumará su bonificador\r\nde competencia en la próxima tirada de ataque o habilidad\r\nque realice.', 1, 'Encantamiento', 30, 'V', 1, 'Clash of Fates', 'Una criatura', '', ''),
(2, 'Frío de Aura', 'Una criatura que puedas ver a 30ft o menos de ti recibe 1d6 de daño de Frío, después, debe hacer una Salvación de Constitución, si falla recibirá un Punto de Escarcha y 1d6 por cada Punto de Escarcha sobre ella o a 5ft de ella.', 2, 'Evocación', 30, 'V S M', 1, 'Clash of Fates', 'Una criatura', '', ''),
(3, 'Soledad de Aura', 'Durante 1 minuto, los Puntos de Escarcha a 40ft o menos de ti se cargan de la soledad que experimentó Aura, desde ese momento, todas las criaturas que pasen por un Punto de Escarcha afectado deben hacer una Salvación de Carisma, si fallan soltarán lo que lleven y se moverán hasta salir de la escarcha, incluso si ya han superado su movilidad.', 2, 'Encantamiento', 40, 'V S M', 1, 'Clash of Fates', 'Área', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `lista_hechizos`
--
...
--
-- Table structure for table `lista_hechizos_hechizos`
--
...
--
-- Table structure for table `pactos`
--
...
(1, 'Humano', 'Raza creada por Athenii, Dios Rúnico de la Batalla.\r\nSon la especie predominante del continente, hábiles maestros de la batalla, saben adaptarse a cualquier conflicto y normalmente los usan a su propio beneficio.', 2, 2, 2, 1, 'Clash of Fates', 30, 'Golpe: 1d4 (Contundente, Fuerza)', 1, 1, 1),
...
--
-- Table structure for table `subclases`
--
...
--
-- Dumping data for table `subclases`
--
...
--
-- Table structure for table `subrazas`
--
...
--
-- Dumping data for table `subrazas`
--

INSERT INTO `subrazas` (`id`, `raza_id`, `nombre`, `descripcion`, `fuerza`, `destreza`, `inteligencia`, `carisma`, `autor`, `ataque_desarmado`, `validado`, `constitucion`, `sabiduria`) VALUES
(1, 1, 'Oriental', 'Humanos de rasgos orientales, piel blanca, pelo de tonalidades negras y ojos generalmente rasgados.\r\nViven en lo que se conoce como Imperio de Hanafu y sus proximidades, no son muy abiertos por lo que no aceptan a según que razas.\r\nCreen en el honor como estilo de vida y lo llevan al límite en sus costumbres.', 2, 1, 1, 1, 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)', 1, 1, 1),
(2, 1, 'Desértico', 'Humanos que habitan principalmente el Imperio de Pheros, de piel oscura y constitución fuerte.\r\nEstán acostumbrados a las extremas temperaturas del desierto y a caminar por sus dunas, hacen lo que sea por su supervivencia.', 1, 1, -1, 1, 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)\r\n', 1, 1, 1),
(3, 1, 'Continental', 'Humanos de piel blanca o morena, habitan la mayor parte del Continente de Deitia, desde el Reino de Orsfon hasta República, son persuasivos y tienden al engaño.', 1, 1, 1, 2, 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)\r\n', 1, 1, 1),
(4, 2, 'Elfo de la Luz', 'Elfos afines a la luz, son capaces de iluminar con su poder mágico innato.\r\nPor lo general suelen ser extrovertidos y lanzados. \r\nSu pelo suele ser blanco o rubio, su piel blanca y sus ojos amarillos.', 0, 0, 0, 0, 'Clash of Fates', 'Golpe: 1d4 (Contundente, Fuerza)', 1, 0, 0);
...
--
-- Indexes for table `lista_hechizos`
--
...
--
-- Indexes for table `lista_hechizos_hechizos`
--
...
--
-- Indexes for table `subclases`
--
ALTER TABLE `subclases`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `subrazas`
--
ALTER TABLE `subrazas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `trasfondo`
--
...
--
-- AUTO_INCREMENT for table `dotes`
--
ALTER TABLE `dotes`
...
--
-- AUTO_INCREMENT for table `lista_hechizos`
--
ALTER TABLE `lista_hechizos`
...
--
-- AUTO_INCREMENT for table `pactos`
--
ALTER TABLE `pactos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `subclases`
--
ALTER TABLE `subclases`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `subrazas`
--
ALTER TABLE `subrazas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `trasfondo`
--
ALTER TABLE `trasfondo`
...
--
-- Constraints for table `lista_hechizos`
--
ALTER TABLE `lista_hechizos`
  ADD CONSTRAINT `FK_B997BF3C9D9D1695` FOREIGN KEY (`clase_id_id`) REFERENCES `clases` (`id`);

--
-- Constraints for table `lista_hechizos_hechizos`
--
ALTER TABLE `lista_hechizos_hechizos`
